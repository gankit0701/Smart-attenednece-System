...
public class DBAdapter extends SQLiteOpenHelper {
	...
	public void addStudent(StudentBean studentBean) {
		...
		String query = "INSERT INTO student_table (student_firstname,student_lastname,student_mobilenumber,student_address,student_department,student_class,student_email) values ('"+
	...
	public ArrayList<StudentBean> getAllStudent()
	{
		...
		if(cursor.moveToFirst()) 
		{
			do{
				...
				studentBean.setStudent_email(cursor.getString(7));
